...
export default function Services() {
  ...
  return (
    <div className="bg:white dark:bg-primary">
      <section
        id="services"
        className="relative block min-h-screen border-b border-t border-secondary px-6 py-10 md:px-10 md:py-20 dark:border-primary dark:bg-primary/30"
      >
        <div className="relative mx-auto max-w-5xl text-center">
          <span className="my-3 flex items-center justify-center font-medium uppercase tracking-wider text-zinc-950 dark:text-gray-400">
            Our Services
          </span>
          <h2 className="dar:to-gray-400 block w-full bg-gradient-to-b from-zinc-950 to-secondary bg-clip-text text-3xl font-bold text-transparent sm:text-4xl dark:from-white">
            Elevate your digital presence with our comprehensive suite of
            services. Choose us for a seamless experience.
          </h2>
          <p className="mx-auto my-4 w-full max-w-4xl bg-transparent text-center font-medium leading-relaxed tracking-wide text-zinc-900 dark:text-gray-400">
